...
public class LoginActivityJ extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*mBottomSheetDialog = new BottomSheetDialog(LoginActivityJ.this);
        View sheetView = LoginActivityJ.this.getLayoutInflater().inflate(R.layout.bottom_layout, null);
        ...
        if(SharedPrefManager.getInstance(this).isDominioNull()) {
            getDominio();
        }
    ...
    public void mostrarBottomDialog() {
    ...
    private void requestPermissions() {
        ...
        final String[] permissions = new String[]{Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.SEND_SMS,Manifest.permission.CALL_PHONE};
    ...
    public void sendNotification1() {
        ...
        Intent notificationIntent = new Intent(this, LoginActivityJ.class);
    ...
    public void sendNotification2() {
        Intent intent = new Intent(this, LoginActivityJ.class);
    ...
    public void sendNotification3() {
        ...
        TaskStackBuilder stackBuilder = TaskStackBuilder
                .create(this);
        stackBuilder.addParentStack(LoginActivityJ.class);
    ...
    public void onClick(View view) {
        if(view == btnLogin) {
            if(SharedPrefManager.getInstance(this).isDominioNull()) {
                ...
                String password = MD5(txdPass.getText().toString());
    ...
    public void sendNotification4() {
        ...
        Intent likeIntent = new Intent(this,LoginActivityJ.class);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String TODO = "";
                            Toast.makeText(LoginActivityJ.this, incidencia, Toast.LENGTH_SHORT).show();
                            /*for(int i = 0; i < arr.length(); i++){
                                JSONObject currentObj = arr.getJSONObject(i);
    ...
    private void usuarioLogin(final String usuario, final String password) {
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            boolean acceso = obj.getBoolean("acceso");
                            String message = obj.getString("message");
                            if(acceso) {
                                String operador = obj.getString("operador");
                                int idPersona = Integer.parseInt(obj.getString("idPersona"));
                                String nombres = obj.getString("nombres");
                                String apaterno = obj.getString("nombres");
                                String amaterno = obj.getString("nombres");
                                ...
                                Intent paso = new Intent(LoginActivityJ.this, MapTest.class);
                               /* paso.putExtra("idPersona", idPersona);
                                paso.putExtra("operador", operador);*/
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                params.put("operador",usuario);
                params.put("uid",android_id);
                //params.put("device",na    medivice);
                return params;
            }
        };
    ...
    public void getDominio() {
        ...
        final ProgressDialog pd = new ProgressDialog(this);
        pd.setMessage("Recuperando Hosting...");
        pd.show();
